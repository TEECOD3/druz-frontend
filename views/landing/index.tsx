    ...
    <Box mt={[16, 20]}>
      <Container>
        ...
        <Text maxWidth="900px" mx="auto" mb={[8, 10]} textAlign="center">
          ...
          set your questions, share your profile link and see what your friends
          think about you!{" "}
          ...
          >
            ...
            <Box>
              <Box
                ...
                backgroundColor="brand.primary"
              >
                <Image src="/images/landing_free.svg" />
              </Box>
              <Text my={2} fontWeight={500} fontSize="lg">
                100% Free
              </Text>
              <Text maxWidth={["400px"]}>
                Access all of Druz&apos; features without having to pay a penny.
              </Text>
            </Box>
          </Stack>
          <Stack
          ...
          >
            <Box mb={{ base: 4, md: 0 }}>
              <Box
                ...
                backgroundColor="brand.primary"
              >
                <Image src="/images/landing_secure.svg" />
              </Box>
              <Text my={2} fontWeight={500} fontSize="lg">
                Secure And Private
              </Text>
              <Text maxWidth={["400px"]}>
                Messages are secured with end to end encryption and your account
                is secure.
              </Text>
            </Box>
            <Box>
              <Box
                ...
                backgroundColor="brand.primary"
              >
                <Image src="/images/landing_simple.svg" />
              </Box>
              <Text my={2} fontWeight={500} fontSize="lg">
                Simple To Use
              </Text>
